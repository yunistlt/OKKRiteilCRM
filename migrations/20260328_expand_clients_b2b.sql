-- Expand clients table for full B2B data
ALTER TABLE clients 
ADD COLUMN IF NOT EXISTS contact_name TEXT,
ADD COLUMN IF NOT EXISTS contact_email TEXT,
ADD COLUMN IF NOT EXISTS orders_count INTEGER DEFAULT 0,
ADD COLUMN IF NOT EXISTS total_summ NUMERIC DEFAULT 0,
ADD COLUMN IF NOT EXISTS average_check NUMERIC DEFAULT 0,
ADD COLUMN IF NOT EXISTS main_contact_id BIGINT;

-- Update the upsert function to handle all new fields
