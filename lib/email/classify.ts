 ...
 *  1) латинский токен `Re` пе�1) "new_request" — НОВАЯ ЗАЯВКА от клиента: запрос коммерческого предложения (КП), счёта, цены, наличия, расчёта, сроков изготовления/поставки МЕТАЛЛОКОНСТРУКЦИЙ/ШКАФОВ/СТЕЛЛАЖЕЙ; ТЗ/спецификация на просчёт нашей продукции; приглашение к участию в тендере/закупке наших товаров. Любое реальное намерение купить НАШУ продукцию / получить НАШЕ предложение.
...
- Отправитель ХОЧЕТ КУПИТЬ наш товар или просит ИЗГОТОВИТЬ/ПОСТАВИТЬ ему металлоконструкции/шкафы/стеллажи ("нужно", "необходимо к закупу", "есть возможность поставки?", "можете поставить/изготовить", прислал ТЗ/спецификацию/карточку предприятия) — это КЛИЕНТ → "new_request". ДАЖЕ если отправитель из "отдела снабжения"/снабженец и пишет слова "закуп", "снабжение", "поставка". Должность отправителя НЕ делает письмо снабжением.
- "procurement" — ТОЛЬКО когда отправитель САМ ПРЕДЛАГАЕТ ПРОДАТЬ что-то НАМ ("предлагаем", "наш прайс", "готовы поставить вам", каталог поставщика, предложение услуг вроде сертификации нашей продукции, корпоративного обучения/семинаров/тренингов для наших сотрудников, логистики, рекламы, IT, клининга). Признак снабжения: он продаёт НАМ (товар или свои услуги), а не мы ему. Если сторонняя компания пишет "оформим для вас документы/сертификаты", "проведем обучение для вашей команды" или "предлагаем сотрудничество" — это предложение услуг НАМ, то есть "procurement", а НЕ "new_request".
3) "logistics" — ЛОГИСТИКА: доставка и отгрузка, сроки и статус доставки, самовывоз, адрес доставки, транспортная компания, габариты/вес/упаковка для перевозки, повреждение/недостача при доставке.
