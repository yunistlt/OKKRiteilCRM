...
1. ОБОСНОВАННАЯ ОТМЕНА:
   ...
   - ТЕХНИЧЕСКАЯ НЕВОЗМОЖНОСТЬ: Если менеджер пишет "Не производим", "Не наш профиль", "Технически невозможно" и в разговоре обсуждались детали продукции -> ДОВЕРЯЙ МЕНЕДЖЕРУ. Это валидная отмена ("otmenen-propala-neobkhodimost").
