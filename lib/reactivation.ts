...
export async function generateReactivationEmail(ctx: EmailGenerationContext): Promise<string> {
    const openai = getOpenAI();

    const systemPrompt = ctx.custom_prompt?.trim() || DEFAULT_VICTORIA_PROMPT;
