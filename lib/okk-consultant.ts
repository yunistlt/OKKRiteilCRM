...
const CONSULTANT_SECTION_CONFIGS: ConsultantSectionConfig[] = [
    {
        ...
        shortTitle: 'Справка',
        summary: 'Справочный раздел по экрану ОКК: что означают колонки, поля, источники данных и как система считает показатели.',
        pathPrefixes: ['/okk'],
        topics: [
            {
                key: 'columns',
            ...
            },
            {
                ...
                answer: [
                    ...
                    '3. Набор заказов, рядом с которыми можно открыть справочный чат Семёна.',
            ...
            },
            {
                ...
                answer: [
                    'Семён в этом чате не проводит аудит конкретного заказа, а объясняет саму механику ОКК.',
                    '',
