    ...
    return (
        <div className="w-full px-4 py-6 md:px-6 md:py-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-8">
                ...
                {/* 2. Violations */}
                <Link href="/analytics/violations" className="group block p-6 md:p-8 bg-white border border-gray-100 shadow-xl shadow-gray-200/50 hover:shadow-2xl hover:shadow-red-200/40 hover:-translate-y-1 transition-all">
                ...
                {/* 3. Quality */}
                <Link href="/analytics/quality" className="group block p-6 md:p-8 bg-white border border-gray-100 shadow-xl shadow-gray-200/50 hover:shadow-2xl hover:shadow-blue-200/40 hover:-translate-y-1 transition-all">
