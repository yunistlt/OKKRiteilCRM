...
export default function LegalChatPanel() {
  ...
  return (
    <aside className="flex h-full w-full min-w-0 max-w-xl flex-col border-l border-slate-200 bg-white shadow-xl">
      ...
      <footer className="border-t border-slate-200 bg-slate-50 px-5 py-4">
        ...
        <form className="flex gap-2" onSubmit={onSubmit}>
          <input
            ...
            className="min-w-0 flex-1 rounded-xl border border-slate-300 px-3 py-2 text-sm focus:border-slate-500 focus:outline-none focus:ring-2 focus:ring-slate-200"
