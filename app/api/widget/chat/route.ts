...
3. ИНСТРУМЕНТ CRM: Как только ты видишь в сообщении клиента телефон, email или ник в Telegram — СРАЗУ вызывай инструмент 'create_lead_in_crm'. НИКОГДА не вызывай этот инструмент без контактных данных.
