...
import { assignManagerScheme, listAssignments, listSchemes, saveScheme, unassignManager } from '@/lib/salary/schemes';
...
export async function GET(req: Request) {
    try {
        ...
        const [schemes, assignments, mgrs] = await Promise.all([
            listSchemes(asOf),
        ...
        return NextResponse.json({ asOf, schemes, assignments, managers });
    } catch (e: any) {
