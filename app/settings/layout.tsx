                    ...
                    {user && (
                        <div className="flex items-center gap-3 px-2 py-2 mb-2">
                            ...
                            <button
                                ...
                                className="p-2 text-gray-400 hover:text-red-600 hover:bg-red-50 rounded-lg transition-colors ml-auto tooltip-btn relative group"
                                title="Выйти"
                            >
                                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M17 16l4-4m0 0l-4-4m4 4H7m6 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h4a3 3 0 013 3v1" /></svg>
                                <div className="absolute hidden group-hover:block bottom-full mb-2 right-0 bg-gray-900 text-white text-[10px] font-bold px-2 py-1 rounded whitespace-nowrap">
                                    Выход
                                </div>
                            </button>
                        </div>
